<div class="bg-neutral-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 py-8 lg:py-12 sm:px-8">
        <!-- Header -->
        <div class="flex items-center justify-between mb-8">
            ...
            <a
                ...
                class="text-sm font-bold text-neutral-500 hover:text-primary-600 hover:underline underline-offset-4 transition-colors p-2 flex items-center gap-2"
            >
                        ...
                        >
                            ...
                            <div class="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto mt-2 sm:mt-0 pt-4 sm:pt-0 border-t border-neutral-100 sm:border-none">
                                ...
                                <div class="flex items-center bg-neutral-50 rounded-full border border-neutral-200 shadow-sm overflow-hidden p-1">
                                    <a
                                        href="<?php echo url('/cart/update?cart_item_id=' . urlencode((string) $item['cart_item_id']) . '&quantity=' . ($item['quantity'] - 1)); ?>"
                                    ...
                                    <span class="w-10 text-center font-bold text-neutral-900 select-none">
                                ...
                                <!-- Remove Button -->
                                <a
                                    href="<?php echo url('/cart/remove?cart_item_id=' . urlencode((string) $item['cart_item_id'])); ?>"
                        ...
                        <div class="border-t border-neutral-100 border-dashed pt-5 mb-8">
                            <div class="flex justify-between items-end">
                                ...
                                <div class="text-right flex flex-col items-end">
                                    <span class="text-4xl font-black text-primary-500 tracking-tighter">
